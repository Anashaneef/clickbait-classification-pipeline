...
Original file is located at
    https://colab.research.google.com/drive/1rswX2J31jv_MOOfILZ5EdcaSuQCjTb05
...
PIPELINE_NAME = "anashaneef-pipeline"
SCHEMA_PIPELINE_NAME = "anashaneef-tfdv-schema"
...
* Clickbait : Information whether including clickbait or not
"""
...
TRANSFORM_MODULE_FILE = "clickbait_transform.py"
...
TUNER_MODULE_FILE = "clickbait_tuner.py"
...
TRAINER_MODULE_FILE = "clickbait_trainer.py"
...
"""## **Analysis and Model Validation Phase**
...
eval_config = tfma.EvalConfig(
    model_specs=[tfma.ModelSpec(label_key='clickbait')],
    ...
    push_destination=pusher_pb2.PushDestination(
        filesystem=pusher_pb2.PushDestination.Filesystem(
            base_directory=os.path.join(
                SERVING_MODEL_DIR, "clickbait-model"
            ),
        )
    )
)
